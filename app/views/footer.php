     ...
     <div class="section-wrapper">
          <div class="rowfooter ">
               <div class="col-6 footer-header">
                    ...
                    <p class="description">
                         Chào mừng bạn đến với Flix Hub – nơi mang đến cho bạn không gian thưởng thức điện ảnh
                         chất lượng cao, nơi mỗi bộ phim đều được trình chiếu một cách sống động và hoàn hảo nhất.
                    </p>
