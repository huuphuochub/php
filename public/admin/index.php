...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
 ...
 <script src="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.min.js"></script>
    ...
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
    <link rel="shortcut icon" href="./assets/img/hp.jpg" type="image/x-icon" />
...
// Tạo truy vấn SQL để lấy dữ liệu doanh thu
$sql = "SELECT MONTH(booking_time) AS month, SUM(total_price) AS doanhthu
        FROM bookings
...
// Lấy dữ liệu từ kết quả truy vấn và cập nhật giá trị trong mảng
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    $months[$row['month']] = $row['doanhthu'];
}

// Chuyển đổi mảng thành dạng dữ liệu cho biểu đồ MorrisJS
$chart_data = array();
foreach ($months as $month => $doanhthu) {
    $chart_data[] = array(
        'month' => 'tháng ' . $month,
        'doanhthu' => $doanhthu
    );
