    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="./Public/admin/dist/img/hp3.jpg" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="../index.php" class="d-block">Fixhub</a>
                </div>
            </div>
           ...
           with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="index.php?action=quanlytheloaiphim&query=them" class="nav-link">
                                    <i class="fa-solid fa-square-plus nav-icon"></i>
                                    <p>Thêm</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="index.php?action=quanlytheloaiphim&query=lietke" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="index.php?action=quanlyxuatchieu&query=them" class="nav-link">
                                    <i class="fa-solid fa-square-plus nav-icon"></i>
                                    <p>Thêm</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="index.php?action=quanlyxuatchieu&query=lietke" class="nav-link">
                                    <i class="fa-solid fa-file-lines nav-icon"></i>
                                    <p>Danh sách</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="index.php?action=quanlytrailer&query=lietke" class="nav-link">
                                    <i class="fa-solid fa-file-lines nav-icon"></i>
                                    <p>Danh sách</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="index.php?action=quanlytrailer&query=them" class="nav-link">
                                    <i class="fa-solid fa-square-plus nav-icon"></i>
                                    <p>Thêm</p>
                                </a>
                            </li>
